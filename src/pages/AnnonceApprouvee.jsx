...
//Comportement
  useEffect(() => {
    ...
    try {
        ...
        setSuccessMessage("Annonce mise en attente ✅");
        setTimeout(() => {
           setSuccessMessage("");
           navigate("/raktakApproved");
        }, 2000);
    } catch (error) {
        setErrorMessage("Erreur lors de la mise en attente ❌");
        console.error(error);
    }
    };
        ...
        <div className="row">
          ...
          <div className="card">
            <div className="card-body">
              <h5 className="card-title">Liste des annonces approuvées</h5>
              ...
              <table className="table table-striped">
                ...
                {annonces.map(a => (
                  <tr key={a.id}>
                    ...
                    <td>{a.statut}</td>
                    <td>   
                        <button type="button" className="btn btn-secondary" onClick={() => handleAccept(a.id)}><i className="bi bi-arrow-repeat"></i></button>
...
export default AnnonceApprouvee